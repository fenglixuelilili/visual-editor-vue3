...
export default {
  group: "个人信息",
  name: "textarea",
  icon: "https://ysys-assets.oss-cn-beijing.aliyuncs.com/public/1726021024983741d172602102498370961_2.png",
  activeIcon:
    "https://ysys-assets.oss-cn-beijing.aliyuncs.com/public/1726021024983741d172602102498370961_2.png",
  render: (block) => {

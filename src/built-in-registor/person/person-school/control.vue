<template>
  <div class="editor-built-in-control-person-school">
    ...
    <div class="flex mt24 options">
      ...
      <div class="pl24">
        <a-input-number
          v-model="block.props.min.defaultValue"
          placeholder="请输入正整数"
          :min="1"
          :max="100"
        >
    ...
    <div class="flex mt24 options">
      <span class="option-label">最多填</span>
      <div class="pl24 flex">
        <a-input-number
          v-model="block.props.max.defaultValue"
          placeholder="请输入正整数"
          :min="1"
          :max="100"
        >
...
@import "../../commen.scss";
.editor-built-in-control-person-school {
  .options {

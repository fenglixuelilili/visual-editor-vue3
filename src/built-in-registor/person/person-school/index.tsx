...
export default {
  group: "个人信息",
  name: "textarea",
  icon: "https://ysys-assets.oss-cn-beijing.aliyuncs.com/public/172602124292989d8172602124292946806_5.png",
  activeIcon:
    "https://ysys-assets.oss-cn-beijing.aliyuncs.com/public/172602124292989d8172602124292946806_5.png",
  render: (block) => {

...
export default {
  group: "个人信息",
  name: "textarea",
  icon: "https://ysys-assets.oss-cn-beijing.aliyuncs.com/public/172602105632353aa172602105632357940_3.png",
  activeIcon:
    "https://ysys-assets.oss-cn-beijing.aliyuncs.com/public/172602105632353aa172602105632357940_3.png",
  render: (block) => {
